...
def build_llm_prompt(context: dict[str, Any], user_question: str | None = None) -> str:
    ...
    prompt_parts = [
        "Ты — аналитик рублевого денежного рынка. Твоя задача: дать краткий и точный комментарий по текущему состоянию LSI.",
        "",
        "СТРОГИЕ ПРАВИЛА:",
        "- Не выдумывай данные, которые не переданы тебе в контексте.",
        "- Если данных нет — прямо скажи об этом.",
        "- Отвечай по-русски, кратко, структурно.",
...
_PERIOD_KEYWORDS: list[tuple[list[str], str, str]] = [
    # (ключевые слова, date_from, date_to)
    (["февраль 2022", "фев 2022", "февраля 2022", "2022-02", "feb 2022"], "2022-02-01", "2022-03-31"),
    (["марте 2022", "март 2022", "марта 2022", "2022-03"], "2022-02-15", "2022-04-15"),
    (["декабрь 2014", "дек 2014", "декабря 2014", "2014-12"], "2014-11-15", "2015-01-15"),
    (["август 2023", "авг 2023", "августа 2023", "2023-08"], "2023-07-15", "2023-09-15"),
